...
- [ ] Items can be taken from resource structures
- [ ] Refactor: 
...
- [ ] Add info texts
"Besides growing vegetables, fruits and small livestock, used for nourishment, the herbalists also cultivate a number of rare flowers and weeds. These plants are not for direct consumption but instead can be used as reagents in various potions and elixirs at the Alchemist. Check the garden every 3 hours for a new harvest."

"After work the labourers at the mill hone their craft by carving small idols and other widgets from spare wood. The workshop van take these bits and bobs and use them for parts in various contraptions. Come back every three hours."

"Every once in a while a miner finds a rare mineral in the sediment. Every three hours these minerals are collected and sent to the surface."      
